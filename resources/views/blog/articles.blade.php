...
<section class=" center blog">
    @if ($articles)
        ...
        @foreach (array_slice($articles, 0, 7) as $article)
            <a href="{{ route('blog.show', ['slug' => $article->slug]) }}" class="section_item">
    ...
    <div class="blog_page section_content">
        ...
        @if ($congratulation)
            <a href="#" class="section_item section_item-announcement">
    ...
    @if ($articles && count($articles) > 13)
        ...
        <button
                class="btn btn-filled btn_big load_more_blog mb20"
